...
/**
 * <p>
 * Prediction of logP based on the atom-type method called XLogP. <b>Requires
 * all hydrogens to be explicit</b>.
 * <p>
 * For description of the methodology see Ref. {
 *
 * @cdk.cite WANG97} and {
 * @cdk.cite WANG00}. Actually one molecular factor is missing (presence of para
 * Hs donor pair).
 *
 * <p>
 ...
 *
 * <p>
 * changed 2005-11-03 by chhoppe<br>
 * -Internal hydrogen bonds are implemented<br>
 * CDK IDescriptor was validated against xlogp2.1<br>
 * As mentioned in the xlogP tutorial don't use charges, always draw bonds. To
 * some extend we can support charges but not in every case.
 * <p>
 * CDK follows the program in following points (which is not documented in the
 * paper):<br>
 ...
 * -Atomtyp C 34/35/36 perception corrected [2005-11-22]; before Atomtyp
 * perception ring perception is done -> slows run time<br>
 *
 *
 *
 * <p>
 * In question:<br>
 * -Correction factor for salicylic acid (in paper, but not used by the
 * program)<br>
 * -Amid classification is not consequent (in 6 rings (R2)N-C(R)=0 is eg 46 and
 * in !6 membered rings it is amid)<br>
 ...
 *
 * <p>
 * changed 2005-11-21 by chhoppe<br>
...
public class XLogPDescriptor extends AbstractMolecularDescriptor implements IMolecularDescriptor {
	 ...
	 *
	 * @return The parameters value [boolean checkAromaticity, boolean
	 * salicylFlag]
	 * @see #setParameters
	 */
	 ...
	 *
	 * If checkAromaticity is true, the method check the aromaticity, if false,
	 * means that the aromaticity has already been checked. It is necessary to
	 * use before the call of this mehtod the
...
//		 ortho oxygen pair
	 ...
	 * indicating the actual type of values returned by the descriptor in the
	...
	/**
	 * Gets the doubleBondedCarbonsCount attribute of the XLogPDescriptor
	 * object.
	 *
	 * @param ac Description of the Parameter
	 * @param atom Description of the Parameter
	...
	/**
	 * Gets the doubleBondedNitrogenCount attribute of the XLogPDescriptor
	 * object.
	 *
	 * @param ac Description of the Parameter
	 * @param atom Description of the Parameter
	...
	/**
	 * Gets the presenceOf Hydroxy group attribute of the XLogPDescriptor
	 * object.
	 *
	 * @param ac Description of the Parameter
	 * @param atom Description of the Parameter
	...
	/**
	 * Gets the presenceOfSulfat A-S(O2)-A attribute of the XLogPDescriptor
	 * object.
	 *
	 * @param ac Description of the Parameter
	 * @param atom Description of the Parameter
	 ...
	 * must be sp2 or sp3 and, for all distances C-1-2-3 only C atoms are
	 * permitted
	 *
	 * @param ac Description of the Parameter
	 * @param atom Description of the Parameter
